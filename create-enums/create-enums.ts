...
interface CountryWithLanguages {
    language: Languages;
    status: string;
}

const countryLanguages: CountryWithLanguages[] = [
    {language: Languages.Spanish, status: "primary"},
    {language: Languages.English, status: "secondary"},
];
